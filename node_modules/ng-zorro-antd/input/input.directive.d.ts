...
export declare class NzInputDirective implements OnChanges, OnInit, OnDestroy {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NzInputDirective, "input[nz-input],textarea[nz-input]", ["nzInput"], { "nzBorderless": "nzBorderless"; "nzSize": "nzSize"; "nzStatus": "nzStatus"; "disabled": "disabled"; }, {}, never>;
}
