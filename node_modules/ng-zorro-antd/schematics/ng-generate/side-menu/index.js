...
function default_1(options) {
    return (host) => __awaiter(this, void 0, void 0, function* () {
        ...
        return (0, schematics_2.chain)([
            ...
            (0, root_module_1.addModule)('AppRoutingModule', './app-routing.module'),
            (0, root_module_1.addModule)('IconsProviderModule', './icons-provider.module'),
            (0, root_module_1.addModule)('NzLayoutModule', 'ng-zorro-antd/layout'),
            (0, root_module_1.addModule)('NzMenuModule', 'ng-zorro-antd/menu')
        ]);
    });
}
